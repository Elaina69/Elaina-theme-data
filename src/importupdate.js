...
class AprilFools {
    ...
    _isNSFWContentEnabled() {
        return ElainaData.get("NSFW-Content") ? "inline" : "none";
    }
                            ...
                            <lol-uikit-dialog-frame class="dialog-frame" orientation="bottom" close-button="false">
                                <div class="dialog-content">
                                    <lol-uikit-content-block class="app-controls-exit-dialog" type="dialog-small" style="width: 400px;">
                                        ...
                                        <hr class="heading-spacer" />
                                        <hr class="heading-spacer" />
                                        <video src="${serverDomain.domain}assets/1-4.webm" controls style="width: 250px; border: 0px; border-radius: 10px; display: ${self._isNSFWContentEnabled()}"></video>
    ...
    async _initializeAprilFools() {
        ...
        if (newdate === "1/4" && !ElainaData.has("3rd-1/4")) {
            ...
            this._setupCloseButtonListener();
